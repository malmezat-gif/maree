...
var client_references_default = {
	"15c18cfaeeff": async () => {
		const m = await import("./assets/layout-segment-context-P9csjWER.js");
		return { get "LayoutSegmentProvider"() {
			return m["LayoutSegmentProvider"];
		} };
	},
	"2e0fea4f4a63": async () => {
		const m = await import("./assets/pwa-registration-Bicg_zmB.js");
		return { get "PwaRegistration"() {
			return m["PwaRegistration"];
		} };
	},
	"593f344dc510": async () => {
		const m = await import("./assets/error-boundary-DY2yKRLu.js");
		return {
			get "ErrorBoundary"() {
	...
	"6efdf509a785": async () => {
		const m = await import("./assets/page-ByTkZ0t-.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"7460d4986a50": async () => {
		const m = await import("./assets/viewport-fit-CLginH_2.js");
		return { get "ViewportFit"() {
			return m["ViewportFit"];
		} };
	},
	"8c0f216c4604": async () => {
